...
//GET Ether Balance:Retrieves the ether balance of the user or the contract
...
//getCDTokensBalance: Retrieves the Crypto Dev tokens in the accountof the provided `address`
